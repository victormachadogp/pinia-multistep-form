<template>
  ...
  <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-3 sm:gap-x-4">
    ...
    <label :class="{ 'active': subscriptionOption === 'Newsletter' }" class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none">
      <input v-model="subscriptionOption" type="radio" name="project-type" value="Newsletter" class="sr-only" aria-labelledby="project-type-0-label" aria-describedby="project-type-0-description-0 project-type-0-description-1">
      ...
      <svg class="h-5 w-5 invisible text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    <!-- Active: "border-indigo-600 ring-2 ring-indigo-600", Not Active: "border-gray-300" -->
    <label :class="{ 'active': subscriptionOption === 'Existing Customers' }" class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none">
      <input v-model="subscriptionOption" type="radio" name="project-type" value="Existing Customers" class="sr-only" aria-labelledby="project-type-1-label" aria-describedby="project-type-1-description-0 project-type-1-description-1">
      <span class="flex flex-1">
        <span class="flex flex-col">
    ...
    <!-- Active: "border-indigo-600 ring-2 ring-indigo-600", Not Active: "border-gray-300" -->
    <label :class="{ 'active': subscriptionOption === 'Trial Users' }" class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none">
      <input v-model="subscriptionOption" type="radio" name="project-type" value="Trial Users" class="sr-only" aria-labelledby="project-type-2-label" aria-describedby="project-type-2-description-0 project-type-2-description-1">
      <span class="flex flex-1">
        <span class="flex flex-col">
